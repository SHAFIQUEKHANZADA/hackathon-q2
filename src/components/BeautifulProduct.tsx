...
const BeautifulProduct = () => {
  return (
    ...
    <div className={`${poppins.className} md:h-[670px] md:pl-20 flex md:flex-row flex-col  items-center`}>
         ...
         <div className='md:w-[404px] md:h-[582px]  relative overflow-hidden'>
          <Image src={"/images/bannerTwo.png"} alt='banner' width={404} height={582} className='transform transition-transform duration-500 hover:scale-110'/>
